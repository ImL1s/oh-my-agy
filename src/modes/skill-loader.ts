 ...
 * Skill 名稱 SSOT 為 `OMA_SKILL_CATALOG_V1`（#41 / OMX catalog-manifest、OMG operation catalog）。
 */
import * as fs from 'fs';
import * as path from 'path';
import { ManagedMode } from './directives';
import { type OmaWorkflowSkill } from './skill-catalog';

export type { OmaWorkflowSkill } from './skill-catalog';
export {
  OMA_SKILL_CATALOG_V1,
  catalogEntryForSkill,
