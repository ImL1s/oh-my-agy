...
describe('Antigravity 1.1.5 frozen worker argv', () => {
  ...
  test.each([
    ['headless', 'read-only', undefined, ['--print', '--print-timeout', '5m0s', '--mode', 'plan', '--sandbox', prompt]],
    ['headless', 'read-write', undefined, ['--print', '--print-timeout', '5m0s', '--mode', 'accept-edits', prompt]],
    ['interactive', 'read-only', undefined, ['--prompt-interactive', '--mode', 'plan', '--sandbox', prompt]],
    ['interactive', 'read-write', undefined, ['--prompt-interactive', '--mode', 'accept-edits', prompt]],
    ['headless', 'read-only', 'conversation-1', ['--conversation', 'conversation-1', '--print', '--print-timeout', '5m0s', '--mode', 'plan', '--sandbox', prompt]],
    ['headless', 'read-write', 'conversation-1', ['--conversation', 'conversation-1', '--print', '--print-timeout', '5m0s', '--mode', 'accept-edits', prompt]],
    ['interactive', 'read-only', 'conversation-1', ['--conversation', 'conversation-1', '--prompt-interactive', '--mode', 'plan', '--sandbox', prompt]],
    ['interactive', 'read-write', 'conversation-1', ['--conversation', 'conversation-1', '--prompt-interactive', '--mode', 'accept-edits', prompt]],
    ...
    expect(result.value[result.value.length - 1]).toBe(prompt);
